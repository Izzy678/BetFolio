...
export function ReviewForm({ uploadId, extraction, issues }: { uploadId: string; extraction: BetslipExtraction; issues: ValidationIssue[] }) {
  ...
  return <div>
    ...
    <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      <div>
        <div className="flex items-center gap-2 text-xs font-semibold text-zinc-300"><Check className="size-4" />Extraction complete</div>
    ...
    <div className="mt-6 grid gap-5 xl:grid-cols-[.78fr_1.22fr]">
      ...
      <Card className="p-5 sm:p-6">
        <div className="mb-6 flex items-center gap-2"><PencilLine className="size-4 text-zinc-400" /><h2 className="text-sm font-semibold">Bet summary</h2></div>
