...
const styles = {
  primary: "bg-lime-300 text-zinc-950 hover:bg-lime-200 shadow-[0_8px_28px_rgba(190,242,100,.12)]",
  secondary: "bg-white/6 text-zinc-100 border border-white/10 hover:bg-white/10",
  outline: "border border-white/20 bg-transparent text-zinc-200 shadow-none hover:border-white/35 hover:bg-white/[.04] hover:text-white",
...
export function buttonClass(variant: keyof typeof styles = "primary", className?: string) {
  return cn("inline-flex h-11 items-center justify-center gap-2 rounded-xl px-4 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lime-300 disabled:pointer-events-none disabled:opacity-50", styles[variant], className);
}
